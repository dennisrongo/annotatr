...
//
// Annotatr ships from two machines (a Mac and a Windows PC) but the Tauri
...
//     --sig-file "path/to/Annotatr.app.tar.gz.sig" \
//     --url "https://github.com/.../v0.3.0/Annotatr.app.tar.gz" \
//     [--notes "Annotatr 0.3.0"]
//
...
const url = args.url;
const notes = args.notes || (version ? `Annotatr ${version}` : undefined);
